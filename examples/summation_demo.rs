...
use mathjit::prelude::*;
use mathjit::summation::{SummationSimplifier, SummationConfig, SummationPattern};
use mathjit::final_tagless::{IntRange, ASTFunction};
use mathjit::Result;
    ...
    let geometric_func = ASTFunction::new(
        ...
        mathjit::final_tagless::ASTRepr::Mul(
            ...
            Box::new(mathjit::final_tagless::ASTRepr::Pow(
                ...
                Box::new(mathjit::final_tagless::ASTRepr::VariableByName("i".to_string()))
            ))
        )
    );
