...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let result1 = math.eval(&expr1, &[3.0, 1.0]);
    ...
    let result2 = math.eval(&expr2, &[0.0, 0.0]);
    ...
    let quad_result = math.eval(&quad, &[1.0]);
    ...
    let gauss_result = math.eval(&gaussian, &[0.0]);
    ...
    let complex_result = math.eval(&complex, &[1.0]);
    ...
    let concise_result = math.eval(&concise_expr, &[3.0]);
