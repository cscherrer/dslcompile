...
fn main() {
    ...
    if rust_time.as_nanos() > 0 {
        ...
        println!("Slowdown vs pure Rust: {:.1}x", slowdown);
    }
    println!();
    ...
    println!("Size of expression: {} bytes", std::mem::size_of_val(&simple_add));
    println!("Size of Var<0>: {} bytes", std::mem::size_of::<Var<0>>());
    println!("Size of Add<Var<0>, Var<1>>: {} bytes", std::mem::size_of::<Add<Var<0>, Var<1>>>());
    println!();
    ...
    println!("Results match: {}", (sum / iterations as f64 - sum_opt / iterations as f64).abs() < 1e-10);
    println!();
    ...
    println!("• Pure Rust addition: {:?} ({:.2} ns/op)", rust_time, rust_time.as_nanos() as f64 / iterations as f64);
    println!("• Compile-time variables: {:?} ({:.2} ns/op)", compile_time_var_time, compile_time_var_time.as_nanos() as f64 / iterations as f64);
    println!("• Array access: {:?} ({:.2} ns/op)", array_access_time, array_access_time.as_nanos() as f64 / iterations as f64);
    println!("• Function calls: {:?} ({:.2} ns/op)", function_call_time, function_call_time.as_nanos() as f64 / iterations as f64);
    println!();
    ...
    println!("• Variable system overhead: {:.1}x", var_overhead);
    println!("• Array access overhead: {:.1}x", array_overhead);
    println!("• Function call overhead: {:.1}x", function_overhead);
    println!();
