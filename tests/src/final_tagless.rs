...
///
/// ```rust
/// use dslcompile::final_tagless::{DirectEval, Expr};
///
...
///
/// ```rust
/// # use dslcompile::final_tagless::{DirectEval, MathExpr, NumericType};
...
///
/// ```rust
/// # use dslcompile::final_tagless::{DirectEval, MathExpr, StatisticalExpr};
