...
impl Multiplicity {
    ...
    pub fn from_rational(numerator: i64, denominator: i64) -> Self {
        if denominator == 0 {
            panic!("Cannot create rational with zero denominator");
        }
        ...
        let result = match (self, other) {
            ...
            (Multiplicity::Rational(n1, d1), Multiplicity::Rational(n2, d2)) => {
                ...
                match n1.checked_mul(d2).zip(n2.checked_mul(d1))
                    ...
                    Some((numerator, denominator)) => Multiplicity::Rational(numerator, denominator),
                    None => Multiplicity::Float((n1 as f64) / (d1 as f64) + (n2 as f64) / (d2 as f64)),
                }
            }
