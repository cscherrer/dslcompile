...
pub fn pretty_ast_indented<T: NumericType>(expr: &ASTRepr<T>, registry: &VariableRegistry) -> String {
    pretty_ast_indented_impl(expr, registry, 0, false)
}

/// Internal implementation for indented pretty printing with depth tracking
fn pretty_ast_indented_impl<T: NumericType>(
    expr: &ASTRepr<T>, 
