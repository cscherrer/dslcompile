...
fn main() {
    ...
    println!("Native Rust:          {:.2}ns per operation → {result}", native_ns);
    ...
    println!("Native Rust:          {:.2}ns per operation → {result}", native_complex_ns);
    ...
    println!("Native Rust:          {:.2}ns per operation → {result}", native_trig_ns);
    ...
    let native_const_ns = native_const_time.as_nanos() as f64 / iterations as f64;
    println!("Native Constant:      {:.2}ns per operation → {result}", native_const_ns);
    ...
    let const_ast_ns = const_ast_time.as_nanos() as f64 / iterations as f64;
    ...
    let folded_ns = folded_time.as_nanos() as f64 / iterations as f64;
