...
fn main() -> Result<()> {
    ...
    println!("Evaluated at x=3, y=4: {} (expected: 7)", add_result);
    ...
    println!("Evaluated at x=3, y=4: {} (expected: 12)", mul_result);
    ...
    println!("Evaluated at x=3, y=4: {} (expected: -1)", sub_result);
    ...
    println!("Evaluated at x=8, y=4: {} (expected: 2)", div_result);
    ...
    println!("Evaluated at x=2: {} (expected: 2*4 + 3*2 + 1 = 15)", poly_result);
    ...
    println!("Evaluated at x=2, y=3, z=4: {} (expected: 6 + 12 + 8 = 26)", three_result);
    ...
    println!("Evaluated at x=0: {} (expected: ~0)", sin_result);
    ...
    println!("Evaluated at x=0: {} (expected: ~1)", cos_result);
    ...
    println!("Evaluated at x=0.5: {} (expected: ~1)", identity_result);
    ...
    println!("Evaluated at x=2, y=3: {} (expected: 8)", power_result);
    ...
    println!("Evaluated at x=0: {} (expected: ~1)", exp_result);
    ...
    println!("Evaluated at x=1: {} (expected: ~0)", ln_result);
