...
fn test_variable_count_mismatch_reproduces_bug() {
    ...
    println!("Variables created: mu={}, sigma={}, x={}, mu2={}, sigma2={}, x1={}, x2={}", 
             mu.var_id(), sigma.var_id(), x.var_id(), mu2.var_id(), sigma2.var_id(), x1.var_id(), x2.var_id());
...
fn test_debug_variable_indices() {
    ...
    for (i, var) in vars.iter().enumerate() {
        ...
        assert_eq!(var.var_id(), i, "Variable index should match creation order");
    }
}