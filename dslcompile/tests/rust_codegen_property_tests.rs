...
use dslcompile::{
    ...
    backends::rust_codegen::{
        RustCodeGenerator, RustCodegenConfig, RustOptLevel, RustCompiler
    },
    prelude::*,
};
use frunk::hlist;
...
mod rust_codegen_unit_tests {
    ...
    fn test_power_operations() {
        ...
        // Test general power
        let pow_expr = ASTRepr::Pow(
            Box::new(x),
            Box::new(ASTRepr::Constant(2.5))
        );
